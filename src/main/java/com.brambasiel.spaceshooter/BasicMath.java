...
public class BasicMath {
	...
	public static int randInt(int min, int max) {
		return (int)lerp((float)min,(float)max, rand.nextFloat());
	}
	...
	public static Color blend(Color x, Color y, float blending) {
		...
		float red =   x.getRed()   * blending   +   y.getRed()   * invBlending;
		float green = x.getGreen() * blending   +   y.getGreen() * invBlending;
		float blue =  x.getBlue()  * blending   +   y.getBlue()  * invBlending;
